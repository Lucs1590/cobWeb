...
Erosion=Tkinter.Button(top,font=("Century",12),text="Clima",command= Clima) 
Erosion.configure(background="black",foreground="white")
erva=Tkinter.Button(top,font=("Century",12),text="Plantas Daninhas",command= Plantas) 
erva.configure(background="black",foreground="white")  
Nivel=Tkinter.Button(top,font=("Century",12),text="Pragas",command= Pragas) 
